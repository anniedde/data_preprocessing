...
celeb_video_map = {
    ...
    'Michael': [
        ...
        # added
        'https://www.youtube.com/watch?v=X67M_MSu8-g',
        'https://www.youtube.com/watch?v=VWeYDFpCZqM',
        'https://www.youtube.com/watch?v=XIDsHwRtkgE',
        'https://www.youtube.com/watch?v=LKp5K1_C7u0',
        'https://www.youtube.com/watch?v=G5OPWW4kIDY',
        'https://www.youtube.com/watch?v=q_zbb6-erGE',
        'https://www.youtube.com/watch?v=GMxJ9j_xZkA',
        'https://www.youtube.com/watch?v=Lr1VNpBO6Zs',
        'https://www.youtube.com/watch?v=VlgAcjhykBg',
        'https://www.youtube.com/watch?v=7FkdCGlK3Us',
        'https://www.youtube.com/watch?v=_Q3zxSOcEso',
        'https://www.youtube.com/watch?v=wfXQ0_cCbAE',
        'https://www.youtube.com/watch?v=Fpappkk-_hU',
        'https://www.youtube.com/watch?v=M37FhweQ4g8',
        'https://www.youtube.com/watch?v=dwbnh5QRjxc',
        'https://www.youtube.com/watch?v=TewRcvD7rGI',
        'https://www.youtube.com/watch?v=8FbX_w1QG9I',
        'https://www.youtube.com/watch?v=A-1TGFW5Kio',
        'https://www.youtube.com/watch?v=CBWZZL9cx8c',
        'https://www.youtube.com/watch?v=LaytBECCYDc'
    ],
    'Sundar': [
    ...
    'Cristiano': [
        'https://www.youtube.com/watch?v=bwOS7fxjS9E',
        'https://www.youtube.com/watch?v=Nm67SpDDdOY',
        'https://www.youtube.com/watch?v=YpjwHazhknA',
        'https://www.youtube.com/watch?v=BK0fNRkVd1Y',
        'https://www.youtube.com/watch?v=6S3t0xERjr0',
        'https://www.youtube.com/watch?v=j8TcR4ihSyE',
        'https://www.youtube.com/watch?v=eu5HUrEHsmc',
        'https://www.youtube.com/watch?v=UNRQCksZmLo',
        'https://www.youtube.com/watch?v=1KJFsm8NDyE',
        'https://www.youtube.com/watch?v=Ri5OXKgbkEc'
    ],
    'Priyanka': [
        'https://www.youtube.com/watch?v=mcrWN3_OJVs',
        'https://www.youtube.com/watch?v=qCSu-X_aEvo',
        'https://www.youtube.com/watch?v=_ixsv0GPnS4',
        'https://www.youtube.com/watch?v=__2ZkKF6qs4',
        'https://www.youtube.com/watch?v=GHq7HVF0zgs',
        'https://www.youtube.com/watch?v=5IdpPNJduHU',
        'https://www.youtube.com/watch?v=yfNpEWZyFTE',
        'https://www.youtube.com/watch?v=ojU-KG_7qFA',
        'https://www.youtube.com/watch?v=Dgz11IPpOB8',
        'https://www.youtube.com/watch?v=PlF9IO9TcIw'
    ],
    'Michelle': [
        'https://www.youtube.com/watch?v=xDnSHicrkE8',
        'https://www.youtube.com/watch?v=p3UQ2ESMJVE',
        'https://www.youtube.com/watch?v=FfaHyDraS84',
        'https://www.youtube.com/watch?v=yc0kcGgg3o0',
        'https://www.youtube.com/watch?v=xHV_vmYoSjY',
        'https://www.youtube.com/watch?v=ZtblLpwX5iU',
        'https://www.youtube.com/watch?v=4ZNWYqDU948',
        'https://www.youtube.com/watch?v=5QLL-jM30QA',
        'https://www.youtube.com/watch?v=yqcevP1eAbE',
        'https://www.youtube.com/watch?v=5iJAE9Utovg'
    ],
...
def extract_frames_video(celeb, video):
    ...
    if not os.path.isdir(output_folder):
        ...
        print(f'Already extracted frames for {celeb} video {video}')
        return
...
def filter_frames_video(celeb, video, threshold=0.3):
    ...
    frames = os.listdir(sharp_frames_dir)
    shuffle(frames)
    for frame in tqdm(frames):
        if len(os.listdir(selected_frames_dir)) >= 50:
            break
...
def copy_to_final_auto_subset_video(celeb, video):
    ...
    notify(f'Finished copying frames to final auto subset folder for {celeb} video {video}. Found {len(os.listdir(dest_dir))} frames.')
...
def copy_photos(celeb, video):
    year = video
    for i in range(0, 20):
        src = '/playpen-nas-ssd/awang/data/{}/{}/train/preprocessed/{}_{}.png'.format(celeb, year, year, i)
        ...
        src = '/playpen-nas-ssd/awang/data/{}/{}/train/preprocessed/{}_{}_mirror.png'.format(celeb, year, year, i)
        dst = '/playpen-nas-ssd/awang/data/{}/all/train/preprocessed/{}_{}_mirror.png'.format(celeb, year, i)
        dst_2 = '/playpen-nas-ssd/awang/data/{}/all/all/train_{}_{}_mirror.png'.format(celeb, year, i)
        shutil.copyfile(src, dst)
        shutil.copyfile(src, dst_2)

        # copy the latent codes too
        src = '/playpen-nas-ssd/awang/data/{}/{}/train/preprocessed/{}_{}_latent.npy'.format(celeb, year, year, i)
        dst = '/playpen-nas-ssd/awang/data/{}/all/train/preprocessed/{}_{}_latent.npy'.format(celeb, year, i)
        dst_2 = '/playpen-nas-ssd/awang/data/{}/all/all/train_{}_{}_latent.npy'.format(celeb, year, i)
        shutil.copyfile(src, dst)
        #shutil.copyfile(src, dst_2)
        src = '/playpen-nas-ssd/awang/data/{}/{}/train/preprocessed/{}_{}_mirror_latent.npy'.format(celeb, year, year, i)
        dst = '/playpen-nas-ssd/awang/data/{}/all/train/preprocessed/{}_{}_mirror_latent.npy'.format(celeb, year, i)
        dst_2 = '/playpen-nas-ssd/awang/data/{}/all/all/train_{}_{}_mirror_latent.npy'.format(celeb, year, i)
        shutil.copyfile(src, dst)
        #shutil.copyfile(src, dst_2)

        # copy the camera params too
        src = '/playpen-nas-ssd/awang/data/{}/{}/train/preprocessed/{}_{}.npy'.format(celeb, year, year, i)
        dst = '/playpen-nas-ssd/awang/data/{}/all/train/preprocessed/{}_{}.npy'.format(celeb, year, i)
        shutil.copyfile(src, dst)
        src = '/playpen-nas-ssd/awang/data/{}/{}/train/preprocessed/{}_{}_mirror.npy'.format(celeb, year, year, i)
        dst = '/playpen-nas-ssd/awang/data/{}/all/train/preprocessed/{}_{}_mirror.npy'.format(celeb, year, i)
...
def copy_test_photos(celeb, video):
    ...
    for i in range(0, 20):
        ...
        dst_2 = '/playpen-nas-ssd/awang/data/{}/all/all/test_{}_{}_mirror.png'.format(celeb, year, i)
        shutil.copyfile(src, dst)
        shutil.copyfile(src, dst_2)

        # copy the camera params too
        src = '/playpen-nas-ssd/awang/data/{}/{}/test/preprocessed/{}.npy'.format(celeb, year, i)
        dst = '/playpen-nas-ssd/awang/data/{}/all/test/preprocessed/{}_{}.npy'.format(celeb, year, i)
        shutil.copyfile(src, dst)
        src = '/playpen-nas-ssd/awang/data/{}/{}/test/preprocessed/{}_mirror.npy'.format(celeb, year, i)
        dst = '/playpen-nas-ssd/awang/data/{}/all/test/preprocessed/{}_{}_mirror.npy'.format(celeb, year, i)
...
def combine_dataset_json(celeb):
    ...
    times = [x for x in os.listdir(celeb) if x.isdigit()]
    for time in times:
        src = '/playpen-nas-ssd/awang/data/{}/{}/train/preprocessed/dataset.json'.format(celeb, time)
        dst = '/playpen-nas-ssd/awang/data/{}/all/train/preprocessed/{}_dataset.json'.format(celeb, time)
        shutil.copyfile(src, dst)
    ...
    for time in times:
        for i in range(0, 20):
            ...
            with open('/playpen-nas-ssd/awang/data/{}/all/train/preprocessed/{}_dataset.json'.format(celeb, time), 'r') as f:
        ...
        os.remove('/playpen-nas-ssd/awang/data/{}/all/train/preprocessed/{}_dataset.json'.format(celeb, time))
...
def combine_test_dataset_json(celeb):
    ...
    times = [x for x in os.listdir(celeb) if x.isdigit()]
    for time in times:
        src = '/playpen-nas-ssd/awang/data/{}/{}/test/preprocessed/dataset.json'.format(celeb, time)
        dst = '/playpen-nas-ssd/awang/data/{}/all/test/preprocessed/{}_dataset.json'.format(celeb, time)
        shutil.copyfile(src, dst)
    ...
    for time in times:
        for i in range(0, 20):
            # get dataset.json file from each year
            with open('/playpen-nas-ssd/awang/data/{}/all/test/preprocessed/{}_dataset.json'.format(celeb, time), 'r') as f:
                year_dataset = json.load(f)
                year_labels = year_dataset['labels']
                for label in year_labels:
                    img_name = label[0]
                ...
                labels += year_labels
        # delete the year_dataset from the directory
        os.remove('/playpen-nas-ssd/awang/data/{}/all/test/preprocessed/{}_dataset.json'.format(celeb, time))
    dataset['labels'] = labels
...
def run_funcs_before_project_latent_code(celeb, video):
    ...
    detector = dlib.get_frontal_face_detector()
    predictor = dlib.shape_predictor('shape_predictor_68_face_landmarks.dat')
    shutil.rmtree(os.path.join('videos', celeb, video, 'eyes_open_frames'), ignore_errors=True)
    ...
    while not os.path.isdir(os.path.join('videos', celeb, video, 'selected_frames')) or len(os.listdir(os.path.join('videos', celeb, video, 'selected_frames'))) < 50:
    ...
    #shutil.rmtree(os.path.join('videos', celeb, video, 'final_auto_subset'), ignore_errors=True)
    if not os.path.exists(os.path.join('videos', celeb, video, 'final_auto_subset')):
        copy_to_final_auto_subset_video(celeb, video)
    """
