...
if __name__ == '__main__':
    ...
    for i in range(10, 20):
        ...
        files = os.listdir(folder)
        for j in range(20):
            assert os.path.isfile(os.path.join(folder, f'{i}_{j}_latent.npy')), f'{folder}/{i}_{j}_latent.npy does not exist'
            assert os.path.isfile(os.path.join(folder, f'{i}_{j}_mirror_latent.npy')), f'{folder}/{i}_{j}_mirror_latent.npy does not exist'
